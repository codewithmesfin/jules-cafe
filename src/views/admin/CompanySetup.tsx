    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        <div className="text-center mb-10">
          <div className="w-20 h-20 bg-[#e17100] rounded-[2.5rem] flex items-center justify-center text-white shadow-xl shadow-red-200 mx-auto mb-6">
            <Building2 size={40} />
          </div>
        ...
        <div className="bg-white rounded-[3rem] shadow-sm border border-slate-100 p-10 md:p-14">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Button
              ...
              className="w-full rounded-2xl h-16 bg-[#e17100] hover:bg-[#ad081b] text-white font-black shadow-lg shadow-red-100 transition-all text-xl gap-3 mt-4"
            >
              {loading ? (
