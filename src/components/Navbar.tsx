          ...
          <div className='flex items-center justify-between w-full max-w-7xl mx-auto'>
            <div className="flex items-center gap-2 md:gap-4 lg:gap-8">
              <Link href={"/"} className="flex items-center gap-2 text-amber-600 font-bold text-xl">
                <ChefHat size={32} />
                <span className="inline">Mevin Cafe</span>
              </Link>
            ...
            <div className="flex items-center gap-3 md:gap-6 lg:gap-8 font-semibold text-black">
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-2 lg:gap-3 ml-3">
                    <Link href={"/login"} className="bg-amber-600 text-white px-4 md:px-5 py-2.5 rounded-full hover:bg-[#ad081b] transition-colors text-sm md:text-base font-bold">
                      Log in
                    </Link>
